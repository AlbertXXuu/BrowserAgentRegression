    ...
    <main id="top">
      <section class="hero">
        ...
        <aside class="hero-proof" aria-label="A baseline check advances until the first controlled browser drift">
          ...
          <div class="proof-orbit" aria-hidden="true"><i></i><i></i><i></i><b></b></div>
          <p>The blue marker follows the clean checkpoints. The violet marker holds the first point changed by the controlled popup.</p>
        </aside>
      </section>
...
.proof-orbit i:nth-child(2){transform-origin:7px 116px;animation:checkpoint-orbit 6.4s var(--ease) infinite}.proof-orbit i:nth-child(3){animation:checkpoint-hit 6.4s var(--ease) infinite}.proof-orbit b{animation:baseline-pulse 3.2s var(--ease) infinite}@keyframes checkpoint-orbit{0%{opacity:0;transform:rotate(0)}7%,24%{opacity:1;transform:rotate(0)}68%,84%{opacity:1;transform:rotate(132deg)}94%,100%{opacity:0;transform:rotate(132deg)}}@keyframes checkpoint-hit{0%,58%,100%{transform:scale(1);box-shadow:0 0 0 rgb(124 58 237 / 0)}72%,84%{transform:scale(1.38);box-shadow:0 0 30px rgb(124 58 237 / 42%)}}@keyframes baseline-pulse{0%,100%{transform:scale(.94);opacity:.82}50%{transform:scale(1.08);opacity:1}}
...
@media(prefers-reduced-motion:reduce){html{scroll-behavior:auto}.liquid-button,.liquid-button::before,.site-header nav a{transition:none}.proof-orbit i,.proof-orbit b{animation:none}}
"""
